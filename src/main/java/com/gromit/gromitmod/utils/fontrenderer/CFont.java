//Credits: https://www.youtube.com/channel/UCOW8D3NEjpU-jBp0V_vAF5w
...
public class CFont {
    public float imgSize = 512;
    public CharData[] charData = new CharData[256];
    public Font font;
    public boolean antiAlias, fractionalMetrics;
    public int fontHeight = -1, charOffset = 0;
