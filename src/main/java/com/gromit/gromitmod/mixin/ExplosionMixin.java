...
public class ExplosionMixin {
    ...
    public void doExplosionA() {
        Explosion explosionClazz = ((Explosion) (Object) this);
                    ...
                    if (j == 0 || j == 15 || k == 0 || k == 15 || l == 0 || l == 15) {
                        ...
                        for (float f1 = 0.3F; f > 0.0F; f -= 0.22500001F) {
                            ...
                            if (iblockstate.getBlock().getMaterial() != Material.air) {
                                float f2 = exploder != null ? exploder.getExplosionResistance(explosionClazz, worldObj, blockpos, iblockstate) : iblockstate.getBlock().getExplosionResistance(worldObj, blockpos, (Entity) null, explosionClazz);
                                f -= (f2 + 0.3F) * 0.3F;
                            }

                            if (f > 0.0F && (exploder == null || exploder.verifyExplosion(explosionClazz, worldObj, blockpos, iblockstate, f))) {
                            }
        ...
        ForgeEventFactory.onExplosionDetonate(worldObj, explosionClazz, list, f3);
            ...
            if (!entity.isImmuneToExplosions()) {
                ...
                if (d12 <= 1.0) {
                    ...
                    if (d13 != 0.0) {
                        ...
                        entity.attackEntityFrom(DamageSource.setExplosionSource(explosionClazz), (float) ((int) ((d10 * d10 + d10) / 2.0 * 8.0 * (double) f3 + 1.0)));
                        double d11 = EnchantmentProtection.func_92092_a(entity, d10);
                        entity.motionX += d5 * d11;
                        entity.motionY += d7 * d11;
                        entity.motionZ += d9 * d11;
                        if (entity instanceof EntityTNTPrimed) {
                            Minecraft.getMinecraft().thePlayer.sendChatMessage("XMotion: " + d5 + "YMotion: " + d7 + "ZMotion: " + d9);
                        }
